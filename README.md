...
**NOTE: Any methods you define on the class (i.e., between the constructor and render methods) should have this structure:** `handleEvent(params) { // do something useful }`

**HOWEVER: Any event handlers you define in JSX elements should use arrow notation (and the concise body syntax, where applicable):**`onEvent={(params) => this.handleEvent(params)}`
